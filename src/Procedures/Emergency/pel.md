...
The PLP is slightly larger than the
...
!!! warning
    Avoid excess use of controls. Especially ailerons, as aircraft control is marginal because of reduced hydraulic flow.
...
2. A normal glide path of 2–3° should be flown,
