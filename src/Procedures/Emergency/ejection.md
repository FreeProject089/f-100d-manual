...
3. Attempt to slow the aircraft as much as practical
before ejection by trading airspeed for altitude.
4. If the aircraft is not controllable, ejection must be
...
ranges is proportionately lower.
...
If the belt is opened manually, seat separation is too
...
ejection can be greatly increased by zooming the aircraft
(if airspeed permits). Ejection should be accomplished
while the aircraft is in a positive climb. This will result
